/**
 * BACKROOMS ESCAPE -- Main Entry Point
 * Creates GameShell, wires callbacks, manages game state.
 * Side-scrolling endless runner with 3 swappable horror themes.
 */
...
const GROUND_H = 120;
const GAME_ID = 'backrooms-escape';
...
const shell = new GameShell({
  ...
  maxDisplayWidth: 480,
  theme: 'horror-run',
  subtitle: 'noclipped out of reality. run.',
  accentColor: '#c4b078',
  shareUrl: 'https://brainrotgames.com/games/game-19/',
});
...
function drawHUD(ctx) {
  ...
  ctx.fillStyle = currentTheme ? currentTheme.accentColor : '#c4b078';
...
function getDeathMessage() {
  ...
  // Interpolate {score} placeholder
  return msg.replace('{score}', String(getTotalScore()));
}
