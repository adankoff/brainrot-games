/**
 * BRAINROT DASH -- Main Entry Point
...
function loadTheme() {
  return getData(GAME_ID, 'theme') || 'aura';
}
...
const shell = new GameShell({
  ...
  shareUrl: 'https://brainrotgames.com/games/game-11/',
});
...
function getDeathMessage(pct) {
  if (pct >= 100) return 'level complete. you actually did it.';
