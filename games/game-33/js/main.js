/**
 * SIGMA GRINDSET SIMULATOR -- Main Entry Point
 * Creates GameShell, wires callbacks, manages game state.
 * Idle clicker with 3 swappable meme theme variants.
 */
...
const shell = new GameShell({
  ...
  maxDisplayWidth: 480,
  theme: 'sigma',
  subtitle: 'tap. grind. ascend.',
  accentColor: '#b44dff',
  shareUrl: 'https://brainrotgames.com/games/game-03/',
});
...
shell.onRender = (ctx) => {
  ...
  // Tap target
  drawTapTarget(ctx, currentTheme, bounceScale, elapsedTime);
